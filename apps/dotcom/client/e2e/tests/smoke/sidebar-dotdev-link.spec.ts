...
const DOT_DEV_URL = 'https://tldraw.dev'

// The link is hidden by UI_SURFACES.sdkPromoLink. Kept and skipped rather than
// deleted so the coverage comes back with the surface if that flag is flipped on.
test.describe.skip('sidebar dot dev link', () => {
