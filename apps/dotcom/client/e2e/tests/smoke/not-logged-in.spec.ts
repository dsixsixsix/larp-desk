...
// The overlay is hidden by UI_SURFACES.anonSdkOverlay. Kept and skipped rather
// than deleted so the coverage comes back with the surface if that flag is
// flipped on.
test.skip('shows anonymous SDK content', async ({ page, homePage }) => {
	await homePage.expectSignInButtonVisible()
