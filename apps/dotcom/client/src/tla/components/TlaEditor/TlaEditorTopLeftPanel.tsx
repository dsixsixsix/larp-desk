...
import { TlaEditorWorkspaceBreadcrumb } from './TlaEditorWorkspaceBreadcrumb'
			...
			<TldrawUiDropdownMenuRoot id={`file-menu-anon`}>
				<TldrawUiMenuContextProvider type="menu" sourceId="dialog">
					...
					<TldrawUiDropdownMenuContent side="bottom" align="start" alignOffset={0} sideOffset={0}>
						...
						<TlaPreferencesGroup />
						{/* No legal summary or cookie settings here, and no sign-in: this build has no
						    accounts to sign in to, and the legal pages belong to tldraw.com rather
						    than to this app. */}
