		...
		<_Tooltip.Provider>
			<div className={styles.dialogContainer}>
				...
				<TldrawUiDialogBody className={styles.dialogBody}>
					<p>
						<F
							defaultMessage="We use cookies to keep you logged in, to sync your files, and to collect analytics to help us improve UnoCode."
							values={{
					...
					<TlaMenuControlGroup>
						...
						<TlaMenuControl>
							...
							<TlaMenuControlInfoTooltip showOnMobile>
								<F defaultMessage="We use analytics cookies to make UnoCode better." />
							</TlaMenuControlInfoTooltip>
							<TlaMenuSwitch
